...
@IonicPage()
@Component({
  selector: 'page-hospitalclaimedinsuranceincomingapporvallist',
  templateUrl: 'hospitalclaimedinsuranceincomingapporvallist.html',
})
export class HospitalclaimedinsuranceincomingapporvallistPage {
