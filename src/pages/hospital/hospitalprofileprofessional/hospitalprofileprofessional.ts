...
@IonicPage()
@Component({
  selector: 'page-hospitalprofileprofessional',
  templateUrl: 'hospitalprofileprofessional.html',
})
export class HospitalprofileprofessionalPage {
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'OK',
          handler: () => {
            let index = this.hospitalProfile.associatedDepartmentList.indexOf(list);

            if (index > -1) {
              this.hospitalProfile.associatedDepartmentList.splice(index, 1);
            }
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'OK',
          handler: () => {
            let index = this.hospitalProfile.associatedLaboratoryList.indexOf(list);

            if (index > -1) {
              this.hospitalProfile.associatedLaboratoryList.splice(index, 1);
            }
            console.log('Item deleted');
          }
        }
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'OK',
          handler: () => {
            let index = this.hospitalProfile.associatedDiseaseList.indexOf(list);

            if (index > -1) {
              this.hospitalProfile.associatedDiseaseList.splice(index, 1);
            }
            console.log('Item deleted');
          }
        }
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'OK',
          handler: () => {
            let index = this.hospitalProfile.associatedMedicalList.indexOf(list);

            if (index > -1) {
              this.hospitalProfile.associatedMedicalList.splice(index, 1);
            }
            console.log('Item deleted');
          }
        }
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'OK',
          handler: () => {
            let index = this.hospitalProfile.associatedDoctorList.indexOf(list);

            if (index > -1) {
              this.hospitalProfile.associatedDoctorList.splice(index, 1);
            }
            console.log('Item deleted');
          }
        }
