...
@IonicPage()
@Component({
  selector: 'page-insuranceplanlist',
  templateUrl: 'insuranceplanlist.html',
})
export class InsuranceplanlistPage {
    ...
    buttons: [
      ...
      },
      {
        ...
        handler: () => {
          ...
          let passParam={"patAppointmentID":data.patAppointmentID,"fclProviderMapID": {"fclProviderMapID":data.fclProviderMapID},
