...
@IonicPage()
@Component({
  selector: 'page-patientclaimedinsurancelistview',
  templateUrl: 'patientclaimedinsurancelistview.html',
})
export class PatientclaimedinsurancelistviewPage {
  item: any=[];
  PatientClaimedInsuranceView:any=[];
  DiseaseData:any=[];
  TempDisease:any=[];
  Medicine:any=[];
  TempMedicine:any=[];
  ...
  ionViewDidLoad() {
    ...
    //this.ViewAppointment=resp;
     ...
     this.PatientClaimedInsuranceView=resp.data;

     let jdiagnosisMasterData=this.PatientClaimedInsuranceView.diagnosisMaster;
     ...
     let drugCompoundMasterData=this.PatientClaimedInsuranceView.drugCompoundMaster;
     ...
     let labReportsLevelData=this.PatientClaimedInsuranceView.labReportsLevel1;
