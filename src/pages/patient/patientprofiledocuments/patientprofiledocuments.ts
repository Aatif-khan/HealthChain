...
/**
 * Generated class for the PatientprofiledocumentsPage page.
 *
...
@IonicPage()
@Component({
  selector: "page-patientprofiledocuments",
  templateUrl: "patientprofiledocuments.html"
})
export class PatientprofiledocumentsPage {
