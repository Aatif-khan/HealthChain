...
@IonicPage()
@Component({
  selector: "page-rebookappointment",
  templateUrl: "rebookappointment.html"
})
export class RebookappointmentPage {
  ...
  getAllDoctors() {
    ...
    this.api
      ...
      .then((resp: any) => {
        ...
        this.getdoctorid(this.fclProviderMapID);
        this.visittype();
      });
  }
  ...
  visitreason() {
    this.api
      ...
      .then((resp: any) => {
        ...
        this.getvisitreasonid(this.visitreasonId);
