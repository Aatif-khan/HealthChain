...
import { DashBoardForMedicalstorePage } from "../dash-board-for-medicalstore/dash-board-for-medicalstore";
...
@IonicPage()
@Component({
  selector: "page-medicalstoreprofiledocument",
  templateUrl: "medicalstoreprofiledocument.html"
})
export class MedicalstoreprofiledocumentPage {
  ...
  cancel() {
    ...
    this.navCtrl.parent.parent.push(DashBoardForMedicalstorePage);
  }
}
